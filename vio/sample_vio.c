...
void SAMPLE_VIO_Usage(char* sPrgNm)
{
    ...
    printf("\t 3)offline mode VI(ROTATE); VO(0:LCD, 1:BT656).Embeded isp, offline, rotate, phychn channel preview.\n");
    printf("\t 4)offline mode VI(LDC); VO(0:LCD, 1:BT656).Embeded isp, offline, LDC, phychn channel preview.\n");
    printf("\t 5)offline mode VI(DIS); VO(0:LCD, 1:BT656).Embeded isp, offline, DIS, phychn channel preview.\n");
